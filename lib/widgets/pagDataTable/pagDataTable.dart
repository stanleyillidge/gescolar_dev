...
class PagDataTable extends StatefulWidget {
  ...
  /// particular [PagDataTable] widget is created; avoid creating a new
  /// [DataTableSource] with each new instance of the [PagDataTable]
  ...
  /// [PagDataTable] widget itself; it should be reused each time the
  /// [PagDataTable] constructor is called.
  ...
  @override
  PagDataTableState createState() => PagDataTableState();
}

/// Holds the state of a [PagDataTable].
///
/// The table can be programmatically paged using the [pageTo] method.
class PagDataTableState extends State<PagDataTable> {
  int _firstRowIndex;
  int _rowCount;
  ...
  @override
  void didUpdateWidget(PagDataTable oldWidget) {
