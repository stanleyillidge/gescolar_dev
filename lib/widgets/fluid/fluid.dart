...
class CustomFluidCell extends StatelessWidget {
  final int size;
  final num heightSize;
  final double height;
  final Widget child;

  const CustomFluidCell.fit({Key key, @required this.size, this.child})
  ...
  const CustomFluidCell.withFixedHeight(
  ...
  const CustomFluidCell.withFluidHeight(
...
class FluidGridView extends StatelessWidget {
  final List<CustomFluidCell> children;
...
class SliverFluidGrid extends SliverFluid {
  ...
  SliverFluidGrid({
    ...
    this.horizontalPadding,
    this.spacing,
    this.children: const <CustomFluidCell>[],
  }) : super(
            key: key,
            fluid: fluid,
            horizontalPadding: horizontalPadding,
