...
class InstitucionForm extends StatefulWidget {
  ...
  InstitucionForm({Key key, this.user, this.onDelete}) : super(key: key);
  @override
  _InstitucionFormState createState() => state;

  bool isValid() => state.validate();
}

class _InstitucionFormState extends State<InstitucionForm> {
