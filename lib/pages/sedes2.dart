...
class Sedes2 extends StatefulWidget {
  Sedes2({Key key}) : super(key: key);

  @override
  _Sedes2State createState() => _Sedes2State();
}

class _Sedes2State extends State<Sedes2> with SingleTickerProviderStateMixin {
  void initState() {
    super.initState();
